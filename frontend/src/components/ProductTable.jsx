         ...
         <Table.Body className="divide-gray-25 divide-y">
            {prouductList.length > 0 ? (
                  ...
                  <Table.Row className="bg-white" key={product._id}>
                     ...
                     <Table.Cell>
                        <div className="flex jsutify-between items-center gap-6">
                           <Button color="primary" variant="outline" onClick={()=> navigate(`/update/${product._id}`)}>
                              Edit
                           </Button>
                           <Button color="error" variant="outline" onClick={() => deleteHandler(product._id)}>
                              Delete
                           </Button>
                        </div>
                     </Table.Cell>
               ...
               <Table.Row className="bg-white flex justify-center">
                  <Table.Cell><p>no product found</p></Table.Cell>
               </Table.Row>
            )}
         </Table.Body>
      </Table>
